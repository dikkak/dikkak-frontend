...
const WorkTitle = ({textRef}: IWorkTitleProps) => {
  ...
  const onClick = () => {
    ...
    textRef.current?.setAttribute('placeholder','추가 요청사항을 작성해주세요');
  };
  return (
    <>
      <MessageBox>
        <Title><Circle color='#905DFB' style={{display: 'inline-block', marginRight: '5px'}}/>기타 파일 업로드 (선택)</Title>
        <SystemMessage>디자인 작업에 참고할 레퍼런스를 등록해주세요</SystemMessage>
